    ...
    <div className="daily-progress p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-6">
        <div className="flex flex-wrap gap-2 border-b border-gray-200">
          {[
            ...
            { key: 'notes', label: 'Notes', icon: FaNoteSticky, count: summaryData.totalNotes },
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-green-50 p-4 rounded-lg border border-green-200">
          <div className="flex items-center">
            <FaNoteSticky className="text-green-600 mr-3" />
            <div>
      ...
      <div className="space-y-6">
        ...
        {(activeTab === 'all' || activeTab === 'notes') && (
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center">
              <FaNoteSticky className="mr-2 text-green-600" />
